    ...
    return (
        <>
            ...
            <div className= 'write-review-modal'>
                {loginModal ? <><div className='overlay' onClick={closeModal}></div> <LoginFormPage modal={loginModal} closeModal={closeModal}/> </> : <ReviewModal hike={hike} open={isOpen} review={review} onClose={(() => setIsOpen(false))} />}
            </div>
        </>
    )
}
