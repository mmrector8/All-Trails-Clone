            ...
            <h1 className='reviews-title'>Reviews ({reviews.length})</h1>
                <div className= "review-top-bucket">
                    <div className='review-avg-rating-bar'>
                        <p>5 <i className="fa-sharp fa-solid fa-star"></i>------</p>
                        <p>4 <i className="fa-sharp fa-solid fa-star"></i>------</p>
                        <p>3 <i className="fa-sharp fa-solid fa-star"></i>------</p>
                        <p>2 <i className="fa-sharp fa-solid fa-star"></i>------</p>
                        <p>1<i className="fa-sharp fa-solid fa-star"></i>------</p>
                    </div>
                    <div className="avg-reviews">
                        <h1 className='avg-stars'>{averageStars()}</h1>
                        <p><i className="fa-sharp fa-solid fa-star"></i><i className="fa-sharp fa-solid fa-star"></i><i className="fa-sharp fa-solid fa-star"></i><i className="fa-sharp fa-solid fa-star"></i><i className="fa-sharp fa-solid fa-star"></i></p>
